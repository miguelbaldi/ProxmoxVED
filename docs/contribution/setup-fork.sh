...
git remote add upstream https://github.com/miguelbaldi/ProxmoxVED.git
...
# upstream   https://github.com/miguelbaldi/ProxmoxVED.git (fetch)
# upstream   https://github.com/miguelbaldi/ProxmoxVED.git (push)
```
...
print_info "Upstream: https://github.com/miguelbaldi/ProxmoxVED"
echo ""
