...
CRONMASTER_ACTION=update bash -c "$(curl -fsSL https://raw.githubusercontent.com/miguelbaldi/ProxmoxVED/refs/heads/feature/anytype-server-miguel/tools/addon/cronmaster.sh)"
UPDATEEOF
