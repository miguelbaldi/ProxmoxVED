...
#
# bash -c "$(curl -fsSL https://raw.githubusercontent.com/miguelbaldi/ProxmoxVED/refs/heads/feature/anytype-server-miguel/tools/pve/cron-update-lxcs.sh)"

set -euo pipefail

REPO_URL="https://raw.githubusercontent.com/miguelbaldi/ProxmoxVED/refs/heads/feature/anytype-server-miguel"
